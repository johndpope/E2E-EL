...
from utils_EL4QA import get_examples, convert_examples_to_features

from modeling_bert import BertModel
from tokenization_bert import BertTokenizer
from configuration_bert import BertConfig
from modeling_EL4QA import DualEncoderBert, PreDualEncoder
        ...
        with torch.no_grad():
            ...
            if args.use_all_candidates:
                mention_inputs = {"args": args,
                                  ...
                                  "mention_start_indices": mention_start_indices.unsqueeze(0), # batch[7],  #overlapping_start_indices,
                                  "mention_end_indices": mention_end_indices.unsqueeze(0), # batch[8], # overlapping_end_indices,
