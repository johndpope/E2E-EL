...
class InputExample(object):
    ...
    def __init__(self, guid, words, labels, gt_candidates):
        ...
        Args:
            ...
            gt_candidates: (Optional) list. The target candidate for each mentions
        """
        self.guid = guid
        self.words = words
        self.labels = labels
    ...
    with open(file_path, encoding="utf-8") as f:
        ...
        for line in f:
            if line.startswith("-DOCSTART-") or line == "" or line == "\n":
                if words:
                    examples.append(InputExample(guid="{}-{}".format(mode, guid_index), words=words, labels=labels, gt_candidates=gt_candidates))
                    guid_index += 1
                    words = []
                    labels = []
                    gt_candidates = []
