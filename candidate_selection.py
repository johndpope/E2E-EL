...
train_data_file = os.path.join(data_dir, 'train_corpus.txt')
test_data_file = os.path.join(data_dir, 'test_corpus.txt')
dev_data_file = os.path.join(data_dir, 'dev_corpus.txt')
